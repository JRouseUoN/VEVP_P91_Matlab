% function [x]=Optim_VE(x0,x_scales,lb,ub,ideal_load_cycle_data_1,ideal_load_cycle_data_2,ideal_load_cycle_data_3,...
%     sigm_check_1,sigm_check_2,sigm_check_3,Rel_Tol);
function [x]=Optim_VE(x0,x_scales,lb,ub,ideal_load_cycle_data_1,ideal_load_cycle_data_2,...
    sigm_check_1,sigm_check_2,Rel_Tol);
...
%     sigm_check_1,sigm_check_2,sigm_check_3,Rel_Tol);
fun=@(x)objective_fun_JPR(x,x_scales,ideal_load_cycle_data_1,ideal_load_cycle_data_2,...
    sigm_check_1,sigm_check_2,Rel_Tol);
...
%     sigm_check_1,sigm_check_2,sigm_check_3,Rel_Tol);
function F=objective_fun_JPR(x,x_scales,ideal_load_cycle_data_1,ideal_load_cycle_data_2,...
    sigm_check_1,sigm_check_2,Rel_Tol);
